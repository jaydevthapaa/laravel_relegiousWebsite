				...
				<div class="row center_o1">
					...
					<div class="col-md-3">
						<div class="center_o1r text-end">
							<h6 class="d-inline-block text-muted bg-white mb-0 p-4  fw-bold"><a class="text-muted a_tag" href="{{url('/')}}">HOME</a> <span class="mx-2 fw-normal">|</span> <span class="col_oran">BLOG</span></h6>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="col-md-6 mb-4">
							<div class="blog_1i">
								...
								<div class="blog_1i2 p-4 bg-white shadow_box">
									...
									<h5 class="mt-3"><a href="{{ url('/blog/'.$blog->id) }}">{{ $blog->title }}</a></h5>
