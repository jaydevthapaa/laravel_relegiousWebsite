...
<section id="shop_dt" class="p_4 pb-0">
  ...
  <div class="carousel-inner">
    <div class="carousel-item">
      <img src="{{asset('img/54.png')}}" class="d-block w-100" alt="abc">
      
    </div>
    <div class="carousel-item active">
      <img src="{{asset('img/55.png')}}" class="d-block w-100" alt="abc">
      
    </div>
    <div class="carousel-item">
      <img src="{{asset('img/56.png')}}" class="d-block w-100" alt="abc">
     ...
     <div class="shop_1im text-center border_1 p-4 hvr-curl-top-right">
	    <div class="shop_1im1 position-relative">
	     <div class="shop_1im1i">
	       <div class="grid clearfix">
			<figure class="effect-jazz mb-0">
			<a href="#"><img src="{{asset('img/54.png')}}" class="w-100" alt="img25"></a>
			</figure>
			</div>
	    </div>
     ...
     <div class="shop_1im text-center border_1 p-4 hvr-curl-top-right">
	    <div class="shop_1im1 position-relative">
	     <div class="shop_1im1i">
	       <div class="grid clearfix">
			<figure class="effect-jazz mb-0">
			<a href="#"><img src="{{asset('img/55.png')}}" class="w-100" alt="img25"></a>
			</figure>
			</div>
	    </div>
		<div class="shop_1im1i1 position-absolute w-100 top-0">
     ...
     <div class="shop_1im text-center border_1 p-4 hvr-curl-top-right">
	    <div class="shop_1im1 position-relative">
	     <div class="shop_1im1i">
	       <div class="grid clearfix">
			<figure class="effect-jazz mb-0">
			<a href="#"><img src="{{asset('img/56.png')}}" class="w-100" alt="img25"></a>
			</figure>
			</div>
	    </div>
		<div class="shop_1im1i1 position-absolute w-100 top-0">
