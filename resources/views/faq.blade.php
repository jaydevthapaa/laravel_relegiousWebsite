        ...
        <div class="row center_o1">
          ...
          <div class="col-md-3">
            <div class="center_o1r text-end">
              <h6 class="d-inline-block text-muted bg-white mb-0 p-4  fw-bold"><a class="text-muted a_tag" href="{{url('/')}}">HOME</a> <span class="mx-2 fw-normal">|</span> <span class="col_oran text-uppercase">Faq</span></h6>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="faq_1l">
          <div class="grid clearfix">
            <figure class="effect-jazz mb-0">
              <a href="#"><img src="{{asset('img/64.jpg')}}" class="w-100" alt="img25"></a>
            </figure>
          </div>
        </div>
      </div>
            ...
            <div class="accordion-item mb-0">
              <h2 class="accordion-header" id="headingsix">
                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapsesix" aria-expanded="true" aria-controls="collapsesix">
                  01. How Do I Book A Visit On Your Website?
                </button>
              </h2>
              <div id="collapsesix" class="accordion-collapse collapse show" aria-labelledby="headingsix" data-bs-parent="#accordionExample1">
                <div class="accordion-body">
                  <p class="mb-0">Arrive Cairo airport, welcome greeting by our representative who will assist you and provide tra nsfers to your Hotel in Cairo. (the clients will inform us about their arrival time minimum 7 days before)</p>
                </div>
              </div>
            </div>
              ...
              <div id="collapseten" class="accordion-collapse collapse" aria-labelledby="headingten" data-bs-parent="#accordionExample1">
                <div class="accordion-body">
                  ...
                  <ul class="mb-0 flex_box">
                    <li class="d-flex"><span><i class="fa fa-check col_oran me-3 align-middle"></i></span> Admire Big Ben, Buckingham Palace And St Paul’s Cathedral</li>
                    <li class="d-flex mt-3"><span><i class="fa fa-check col_oran me-3 align-middle"></i></span> Chance To Spot Prominent Landmarks Of The City
                    </li>
                  </ul>
                </div>
              </div>
